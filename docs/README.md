...
**进度**：阶段一（里程碑 **1** / 工程 **A+B**）已在代码库落地，下文档中凡标「✅ 阶段一」处表示该块目标已达成；后续迭代以里程碑 **2** 起为主。

| 文档 | 内容 |
|------|------|
| [product-goal.md](./product-goal.md) | 目标、边界、产品路线 1–5（路线 1 已 ✅） |
| [roadmap.md](./roadmap.md) | 里程碑 1–5、工程 A–C、依赖（1 与 A+B 已 ✅） |
